...
function ejecutar(accion, params) {
  try {
    ...
    switch (accion) {
      ...
      case 'subirArchivoResultado':     return subirArchivoResultado(params);
      case 'quitarArchivoResultado':    return quitarArchivoResultado(params);
      ...
      case 'darAdelantoHonorario':    return darAdelantoHonorario(params);
